...
void CookFONLLPythiaPred(std::string inFileNameMin = "DfromB_FONLLminPythia8_FFee_yDcut_sqrts5500.root", // min FONLL predictions
                          std::string inFileNameCent = "DfromB_FONLLcentPythia8_FFee_yDcut_sqrts5500.root", // central FONLL predictions
                          std::string inFileNameMax = "DfromB_FONLLmaxPythia8_FFee_yDcut_sqrts5500.root",  // max FONLL predictions
                          std::string outFileName = "DmesonLcPredictions_sqrt5500_y05_pythia8_FFee_BRPDG.root",
                          int brOpt = kBRPDG,
                          int ffOpt = kFFee, //kFFOriginal,
                          int wOpt = kAccurate) { //kSimple) {
