...
/// \cond CLASSIMP
ClassImp(AliHFInvMassFitter1);
/// \endcond

/////////////////////////////////////////////////////////////
///
/// Implemenatation od AliHFInvMassFitter1 class for
...
AliHFInvMassFitter1::AliHFInvMassFitter1() :
  TNamed(),
  fHistoInvMass(0x0),
  fMinMass(0),
  fMaxMass(5),
...
//__________________________________________________________________________
AliHFInvMassFitter1::AliHFInvMassFitter1(const TH1F *histoToFit, Double_t minvalue, Double_t maxvalue, Int_t fittypeb, Int_t fittypes):
  TNamed(),
  fHistoInvMass(0x0),
  fMinMass(minvalue),
  fMaxMass(maxvalue),
...
//__________________________________________________________________________
void AliHFInvMassFitter1::SetNumberOfParams(){
...
//__________________________________________________________________________
Int_t AliHFInvMassFitter1::MassFitter(Bool_t draw){
...
void AliHFInvMassFitter1::DrawFit(){
...
//______________________________________________________________________________
void AliHFInvMassFitter1::DrawHere(TVirtualPad* c, Double_t nsigma,Int_t writeFitInfo){
...
//______________________________________________________________________________
Double_t AliHFInvMassFitter1::CheckForSignal(Double_t mean, Double_t sigma){
...
//______________________________________________________________________________
TF1* AliHFInvMassFitter1::CreateBackgroundFitFunction(TString fname, Double_t integral){
  /// Creates the background fit fucntion
  ///

  SetNumberOfParams();
  TF1* funcbkg =  new TF1(fname.Data(),this,&AliHFInvMassFitter1::FitFunction4Bkg,fMinMass,fMaxMass,fNParsBkg,"AliHFInvMassFitter1","FitFunction4Bkg");
  switch (fTypeOfFit4Bkg) {
  case 0: //gaus+expo
...
//______________________________________________________________________________
TF1* AliHFInvMassFitter1::CreateSecondPeakFunction(TString fname, Double_t integsig){
  ...
  TF1* funcsec =  new TF1(fname.Data(),this,&AliHFInvMassFitter1::FitFunction4SecPeak,fMinMass,fMaxMass,3,"AliHFInvMassFitter1","FitFunction4SecPeak");
...
//______________________________________________________________________________
TF1* AliHFInvMassFitter1::CreateReflectionFunction(TString fname){
  /// Creates a function for reflections contribution
  /// in the D0->Kpi inv. mass distribution
  TF1* funcrfl =  new TF1(fname.Data(),this,&AliHFInvMassFitter1::FitFunction4Refl,fMinMass,fMaxMass,1,"AliHFInvMassFitter1","FitFunction4Refl");
...
//______________________________________________________________________________
TF1* AliHFInvMassFitter1::CreateBackgroundPlusReflectionFunction(TString fname){
  /// Creates the function with sum of background and reflections
  ///
  SetNumberOfParams();
  Int_t totParams=fNParsBkg+fNParsRfl;
  TF1* fbr=new TF1(fname.Data(),this,&AliHFInvMassFitter1::FitFunction4BkgAndRefl,fMinMass,fMaxMass,totParams,"AliHFInvMassFitter1","FitFunction4BkgAndRefl");
  for(Int_t ipar=0; ipar<fNParsBkg; ipar++){
...
//______________________________________________________________________________
TF1* AliHFInvMassFitter1::CreateSignalFitFunction(TString fname, Double_t integsig){
  /// Creates the fit function for the signal peak
  ///

  SetNumberOfParams();
  TF1* funcsig =  new TF1(fname.Data(),this,&AliHFInvMassFitter1::FitFunction4Sgn,fMinMass,fMaxMass,fNParsSig,"AliHFInvMassFitter1","FitFunction4Sgn");
...
//______________________________________________________________________________
TF1* AliHFInvMassFitter1::CreateTotalFitFunction(TString fname){
  ...
  TF1* ftot=new TF1(fname.Data(),this,&AliHFInvMassFitter1::FitFunction4Mass,fMinMass,fMaxMass,totParams,"AliHFInvMassFitter1","FitFunction4Mass");
  for(Int_t ipar=0; ipar<fNParsBkg; ipar++){
...
//__________________________________________________________________________
Double_t AliHFInvMassFitter1::FitFunction4Bkg (Double_t *x, Double_t *par){
...
//_________________________________________________________________________
Double_t AliHFInvMassFitter1::FitFunction4Sgn (Double_t *x, Double_t *par){
...
//_________________________________________________________________________
Double_t AliHFInvMassFitter1::FitFunction4Refl(Double_t *x,Double_t *par){
...
//_________________________________________________________________________
Double_t AliHFInvMassFitter1::FitFunction4BkgAndRefl(Double_t *x, Double_t *par){
...
//_________________________________________________________________________
Double_t AliHFInvMassFitter1::FitFunction4SecPeak (Double_t *x, Double_t *par){
...
//_________________________________________________________________________
Double_t AliHFInvMassFitter1::FitFunction4Mass(Double_t *x, Double_t *par){
...
//_________________________________________________________________________
void AliHFInvMassFitter1::Signal(Double_t nOfSigma,Double_t &signal,Double_t &errsignal) const {
...
//_________________________________________________________________________
void AliHFInvMassFitter1::Signal(Double_t min, Double_t max, Double_t &signal,Double_t &errsignal) const {
...
void AliHFInvMassFitter1::Background(Double_t nOfSigma,Double_t &background,Double_t &errbackground) const {
...
//___________________________________________________________________________
void AliHFInvMassFitter1::Background(Double_t min, Double_t max, Double_t &background,Double_t &errbackground) const {
...
void AliHFInvMassFitter1::Significance(Double_t nOfSigma,Double_t &significance,Double_t &errsignificance) const  {
...
void AliHFInvMassFitter1::Significance(Double_t min, Double_t max, Double_t &significance,Double_t &errsignificance) const {
...
Bool_t AliHFInvMassFitter1::PrepareHighPolFit(TF1 *fback){
  ...
  while(fCurPolDegreeBkg<=fPolDegreeBkg){
    funcbkg = new TF1(Form("temp%d",fCurPolDegreeBkg),this,&AliHFInvMassFitter1::BackFitFuncPolHelper,fMinMass,fMaxMass,fCurPolDegreeBkg+1,"AliHFInvMassFitter1","BackFitFuncPolHelper");
    if(funcPrev){
...
Double_t AliHFInvMassFitter1::BackFitFuncPolHelper(Double_t *x,Double_t *par){
...
// _______________________________________________________________________
TH1F* AliHFInvMassFitter1::SetTemplateReflections(const TH1 *h, TString opt,Double_t minRange,Double_t maxRange){
...
// _______________________________________________________________________
Double_t AliHFInvMassFitter1::GetRawYieldBinCounting(Double_t& errRyBC, Double_t nOfSigma, Int_t option, Int_t pdgCode) const{
...
// _______________________________________________________________________
Double_t AliHFInvMassFitter1::GetRawYieldBinCounting(Double_t& errRyBC, Double_t minMass, Double_t maxMass, Int_t option) const{
  /// Method to compute the signal using inv. mass histo bin counting
...
// _______________________________________________________________________
TH1F* AliHFInvMassFitter1::GetResidualsAndPulls(TH1 *hPulls,TH1 *hResidualTrend,TH1 *hPullsTrend, Double_t minrange,Double_t maxrange, Int_t option){
...
// _______________________________________________________________________
TH1F* AliHFInvMassFitter1::GetOverBackgroundResidualsAndPulls(TH1 *hPulls,TH1 *hResidualTrend,TH1 *hPullsTrend, Double_t minrange,Double_t maxrange){
  ///
  return GetResidualsAndPulls(hPulls,hResidualTrend,hPullsTrend,minrange,maxrange,1);
}
// _______________________________________________________________________
TH1F* AliHFInvMassFitter1::GetOverBackgroundPlusReflResidualsAndPulls(TH1 *hPulls,TH1 *hResidualTrend,TH1 *hPullsTrend, Double_t minrange,Double_t maxrange){
  ///
  return GetResidualsAndPulls(hPulls,hResidualTrend,hPullsTrend,minrange,maxrange,2);
}

// _______________________________________________________________________
void AliHFInvMassFitter1::PrintFunctions(){
