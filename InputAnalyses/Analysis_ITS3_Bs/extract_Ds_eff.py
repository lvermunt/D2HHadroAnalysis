...
def match_Dseff_toBs_binning(path, fout):
    ...
    h_match_pr04.Scale(1./h_match_pr04.Integral())
    h_match_pr48.Scale(1. / h_match_pr48.Integral())
    h_match_pr812.Scale(1. / h_match_pr812.Integral())
    h_match_pr1216.Scale(1. / h_match_pr1216.Integral())
    h_match_pr1624.Scale(1. / h_match_pr1624.Integral())

    h_match_fd04.Scale(1./h_match_fd04.Integral())
    h_match_fd48.Scale(1. / h_match_fd48.Integral())
    h_match_fd812.Scale(1. / h_match_fd812.Integral())
    h_match_fd1216.Scale(1. / h_match_fd1216.Integral())
    h_match_fd1624.Scale(1. / h_match_fd1624.Integral())
